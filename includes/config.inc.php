 ...
 */
define('CUSTOM_FUNCTIONS', 'class.Chicago.inc.php');
 ...
 */
define('SITE_TITLE', 'Chicago Decoded');

/*
 * What is the name of the place that these laws govern?
 */
define('PLACE_NAME', 'Chicago');

/*
 * What does this state call its laws?
 */
define('LAWS_NAME', 'Municipal Code of the city of Chicago');
 ...
 */
define('PDO_DSN', 'mysql:dbname=chicagodecoded;host=localhost;charset=utf8');
define('PDO_USERNAME', 'root');
define('PDO_PASSWORD', 'birk1954');
